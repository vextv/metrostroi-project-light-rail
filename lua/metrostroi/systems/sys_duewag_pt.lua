...
function TRAIN_SYSTEM:Think(Train)
	...
	--Only on the * Setting of the reverser lever should the battery turn on
	...
	elseif self.BatteryStartUnlock == true or self.Train:ReadTrainWire(7) == 1 then
		--Except if the leading cab turns the batteries on for the entire train
		self.BatteryOn = true
